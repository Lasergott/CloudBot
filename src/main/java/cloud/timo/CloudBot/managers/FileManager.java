...
public class FileManager {
    ...
    private void saveConfig() {
        try {
            ...
            CloudBot.severe("Error while saving config: ");
            e.printStackTrace();
        }
    }
    ...
    public String getString(String path) {
     return CloudBot.getInstance().getFileManager().getConfig().get(path).toString();
    }
    public Integer getInt(String path) {
        return (Integer) CloudBot.getInstance().getFileManager().getConfig().get(path);
    }
}
